...
OPTIONS="--backbone resnet101 --warm_up --warm_epochs 15 --warm_lr_scale 500 --unce_in_warm --checkpoint /mnt/gpfs/renyong/CSS/checkpoints_ep30_60/step/ --pod local --pod_factor 0.001 --pod_logits --pseudo entropy --threshold 0.001 --classif_adaptive_factor --init_balanced --results_dir ${results_dir}"
