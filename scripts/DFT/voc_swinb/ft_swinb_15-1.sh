...
OPTIONS="--backbone swin_b --checkpoint /mnt/gpfs/renyong/CSS/checkpoints/step/"
...
if [ -f /mnt/gpfs/renyong/CSS/checkpoints/step/${TASK}-${DATASET}_FT-SwinB-0.02_0.pth ]; then
    echo "Task 0 checkpoint already exists, skipping ..."
    cp /mnt/gpfs/renyong/CSS/checkpoints/step/${TASK}-${DATASET}_FT-SwinB-0.02_0.pth /mnt/gpfs/renyong/CSS/checkpoints/step/${TASK}-${DATASET}_${NAME}_0.pth
