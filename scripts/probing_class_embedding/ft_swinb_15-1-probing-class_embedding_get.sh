...
readonly TASK="15-5s-probing"
readonly NAME="FT-SwinB-FixB-0.001"
readonly METHOD="FT"
readonly OPTIONS="--backbone swin_b --checkpoint /mnt/gpfs/renyong/CSS/checkpoints_probing/step/ --fix_bachbone --test"
