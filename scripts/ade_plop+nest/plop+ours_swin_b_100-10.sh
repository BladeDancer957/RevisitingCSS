...
OPTIONS="--backbone swin_b --warm_up --warm_epochs 15 --warm_lr_scale 500 --unce_in_warm --checkpoint /mnt/gpfs/renyong/CSS/checkpoints/step/ --pod local --pod_factor 0.001 --pod_logits --pseudo entropy --threshold 0.001 --classif_adaptive_factor --init_balanced"
