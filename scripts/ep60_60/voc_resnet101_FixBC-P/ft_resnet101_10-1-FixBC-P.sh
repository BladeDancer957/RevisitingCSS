...
OPTIONS="--backbone resnet101 --checkpoint /mnt/gpfs/renyong/CSS/checkpoints_ep60/step/ --fix_bachbone --fix_pre_cls --pre_allocate --task_num 11 --results_dir ${results_dir}"
