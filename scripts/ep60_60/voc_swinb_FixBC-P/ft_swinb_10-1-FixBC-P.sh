...
OPTIONS="--backbone swin_b --checkpoint /mnt/gpfs/renyong/CSS/checkpoints_ep60/step/ --fix_backbone --fix_pre_cls --pre_allocate --task_num 11 --results_dir ${results_dir}"
...
if [ -f /mnt/gpfs/renyong/CSS/checkpoints_ep60/step/${TASK}-${DATASET}_FT-SwinB-FixBC-P-0.0005_0.pth ]; then
    ...
    if [ ! -f /mnt/gpfs/renyong/CSS/checkpoints_ep60/step/${TASK}-${DATASET}_${NAME}_0.pth ]; then
        cp /mnt/gpfs/renyong/CSS/checkpoints_ep60/step/${TASK}-${DATASET}_FT-SwinB-FixBC-P-0.0005_0.pth /mnt/gpfs/renyong/CSS/checkpoints_ep60/step/${TASK}-${DATASET}_${NAME}_0.pth
    fi
