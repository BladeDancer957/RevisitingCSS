...
OPTIONS="--backbone resnet101 --checkpoint /mnt/gpfs/renyong/CSS/checkpoints_ep30_60/step/ --fix_bachbone --fix_pre_cls --pre_allocate --task_num 2 --results_dir ${results_dir}"
...
if [ -f /mnt/gpfs/renyong/CSS/checkpoints_ep30_60/step/${TASK}-${DATASET}_FT-FixBC-P-0.05_0.pth ]; then
    ...
    if [ ! -f /mnt/gpfs/renyong/CSS/checkpoints_ep30_60/step/${TASK}-${DATASET}_${NAME}_0.pth ]; then
        ...
        cp /mnt/gpfs/renyong/CSS/checkpoints_ep30_60/step/${TASK}-${DATASET}_FT-FixBC-P-0.05_0.pth /mnt/gpfs/renyong/CSS/checkpoints_ep30_60/step/${TASK}-${DATASET}_${NAME}_0.pth
    fi
