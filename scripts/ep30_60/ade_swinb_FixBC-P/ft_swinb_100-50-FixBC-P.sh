...
OPTIONS="--backbone swin_b --checkpoint /mnt/gpfs/renyong/CSS/checkpoints_ep30_60/step/ --fix_backbone --fix_pre_cls --pre_allocate --task_num 2 --results_dir ${results_dir}"
...
# FIRSTMODEL=/home/renyong/ECCV24_NeST/checkpoints/step/100-50-voc_FT-fixbb-fixcls-preallocate_0.pth
...
if [ -f /mnt/gpfs/renyong/CSS/checkpoints_ep30_60/step/${TASK}-${DATASET}_FT-SwinB-FixBC-P-0.05_0.pth ]; then
    echo "Task 0 checkpoint already exists, skipping ..."
    if [ ! -f /mnt/gpfs/renyong/CSS/checkpoints_ep30_60/step/${TASK}-${DATASET}_${NAME}_0.pth ]; then
        echo "Copying task 0 checkpoint to new name ..."
        cp /mnt/gpfs/renyong/CSS/checkpoints_ep30_60/step/${TASK}-${DATASET}_FT-SwinB-FixBC-P-0.05_0.pth /mnt/gpfs/renyong/CSS/checkpoints_ep30_60/step/${TASK}-${DATASET}_${NAME}_0.pth
    fi
