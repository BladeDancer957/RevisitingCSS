...
OPTIONS="--backbone swin_b --checkpoint /mnt/gpfs/renyong/CSS/checkpoints_ep30_60/step/ --fix_bachbone --fix_pre_cls --pre_allocate --task_num 2 --results_dir ${results_dir}"
