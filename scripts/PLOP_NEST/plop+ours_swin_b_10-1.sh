...
DATASET=voc
TASK=10-1
NAME=PLOP_NEST-SwinB
METHOD=FT 
# relevant parameters are set here
results_dir=results_plop_nest
OPTIONS="--backbone swin_b --warm_up --warm_epochs 5 --warm_lr_scale 1 --unce_in_warm --checkpoint checkpoints/step/ --fix_pre_cls --pod local --pod_factor 0.01 --pod_logits  --pseudo entropy --threshold 0.001 --classif_adaptive_factor --init_balanced --results_dir ${results_dir}"
